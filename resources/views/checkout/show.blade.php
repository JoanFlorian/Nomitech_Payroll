            ...
            <form action="{{ route('checkout.session', $pago->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="verification_code" id="verification_code" 
                        class="w-full px-3 py-2 border @error('verification_code') border-red-500 @else border-gray-300 @enderror rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
