...
<div class="bg-white rounded-2xl border border-gray-100 shadow-sm p-5 md:p-8">
    ...
    <form method="GET" action="{{ route('nomina.index') }}" class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
        ...
        <div>
            ...
            <input type="text" id="periodo-liquidacion" name="periodo" value="{{ request('periodo') }}"
        ...
        <div class="flex items-end justify-end gap-3 pb-0.5">
            <button type="button" id="btn-editar-empleado" title="Editar empleado seleccionado" disabled
            ...
            @if($periodoActivo && $periodoActivo->estado !== \App\Models\PeriodoLiquidacion::ESTADO_CERRADO)
                <a href="{{ route('nomina.step1', ['fresh' => 1]) }}" title="Crear nueva nomina" class="bg-green-600 hover:bg-green-700 text-white
            ...
            @else
                <button type="button" disabled title="Periodo cerrado o no seleccionado" class="bg-gray-300 text-white
                                      rounded-full w-12 h-12 flex items-center
                                      justify-center text-2xl shadow-md opacity-50 cursor-not-allowed">
                    +
                </button>
            @endif
        </div>
        ...
        <div class="md:col-span-2 flex flex-wrap gap-2 justify-end">
            <button type="submit" formaction="{{ route('nomina.index') }}"
            ...
            <button type="submit" formaction="{{ route('nomina.export.pdf') }}"
        ...
        <table class="w-full text-sm border-collapse min-w-[720px]">
            ...
            <thead class="bg-blue-600 text-white">
                <tr>
                    ...
                    <th class="px-4 py-3 text-right font-semibold tracking-wide">Neto a pagar</th>
                </tr>
            </thead>
