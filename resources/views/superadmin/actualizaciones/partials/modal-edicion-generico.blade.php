...
<div id="modalEdicion" class="fixed inset-0 bg-black/60 hidden items-center justify-center z-50 p-4 backdrop-blur-sm">
    <div class="bg-white rounded-2xl w-full max-w-2xl p-8 relative shadow-2xl border border-gray-100 max-h-screen overflow-y-auto">
        ...
        <!-- Botón cerrar -->
        <button onclick="cerrarModalEdicion()" class="absolute top-4 right-4 text-gray-400 hover:text-gray-600 transition p-2">
        ...
        <div class="mb-8 pb-6 border-b border-gray-200">
            <div class="flex items-start gap-4">
                <div id="headerIcono" class="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center shadow-lg flex-shrink-0">
        ...
        <!-- Formulario dinámico -->
        <form id="formEdicion" method="POST" action="" class="space-y-6">
            @csrf
            @method('PUT')
