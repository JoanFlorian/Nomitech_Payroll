...
<div class="p-6 bg-gray-50">
   ...
   <div class="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg border p-8 mb-0">
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-3 mt-8">
            ...
            <a href="#"
               class="px-5 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700 transition shadow">
    ...
    <div class="bg-white rounded-2xl w-full max-w-2xl mx-auto shadow-2xl overflow-hidden">
        ...
        <form method="POST" action="{{ route('superadmin.empresas.update', $empresa->id_empresa) }}">
                    ...
                    <select name="id_ciudad"
                        ...
                        @foreach($ciudades as $ciudad)
                            <option value="{{ $ciudad->id_ciudad }}"
                                {{ $empresa->id_ciudad == $ciudad->id_ciudad ? 'selected' : '' }}>
                                {{ $ciudad->nombre }}
                            </option>
                        @endforeach
                    </select>
            ...
            <div class="px-6 py-4 border-t bg-gray-50 flex justify-end gap-3">
                ...
                <button type="submit"
                        class="px-5 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 shadow">
                    Guardar cambios
                </button>
            </div>
        </form>
