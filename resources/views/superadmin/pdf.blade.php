...
<body>
    <div class="container">
        ...
        <div class="section">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td>
                            <strong>{{ ($planParaPdf ?? $licencia->plan)->nombre ?? 'Plan de suscripción' }}</strong><br>
                            <small>{{ ($planParaPdf ?? $licencia->plan)->descripcion ?? 'Acceso a plataforma Nomitech' }}</small>
                        </td>
        ...
        <div class="footer">
            ...
            <p class="no-print" style="margin-top: 20px; color: #333; font-weight: bold;">Para descargar en PDF: Use
                Imprimir (Ctrl+P) → Guardar como PDF</p>
        </div>
    </div>
</body>
