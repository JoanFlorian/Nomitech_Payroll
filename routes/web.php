...
Route::middleware(['auth', 'prevent_back_history'])->group(function () {
    ...
    Route::get('/licencia/required', function () {
            return redirect()->to(route('index') . '#pricing');
        }
...
Route::middleware(['auth', 'ensure_active_license', 'contractual_access', 'prevent_back_history', 'must_change_password', 'check_first_period'])->group(function () {
    ...
    // Rutas de RenovaciÃ³n y Datos de Contrato
    ...
    // Rutas de exportaciÃ³n de PILA (controlador especializado)
...
Route::middleware(['auth', 'ensure_active_license', 'contractual_access', 'admin_empresa', 'permission:manage_catalogos', 'prevent_back_history', 'must_change_password'])
    ...
    ->group(function () {
        ...
        // GestiÃ³n de Roles y Permisos (Protected by admin_empresa, but not strictly by manage_catalogos)
        ...
        Route::post('/notas-ajuste/{notaAjuste}/preview-impacto', [NotaAjusteController::class , 'previewImpactoNota'])->name('notas-ajuste.preview-impacto');
        Route::post('/notas-ajuste/{notaAjuste}/guardar-detalles', [NotaAjusteController::class , 'adminGuardarDetalles'])->name('notas-ajuste.guardar-detalles');
    });
...
// Cambiar contraseÃ±a obligatorio en primer ingreso
...
// Portal del Trabajador (solo autenticaciÃ³n requerida)
