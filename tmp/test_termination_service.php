...
// Test continuity check (needs DB)
/*
echo "Checking labor continuity...\n";
$hasContinuity = $service->checkLaborContinuity('1010101010', Carbon::parse('2026-03-15'));
echo "Has continuity: " . ($hasContinuity ? 'Yes' : 'No') . "\n";
*/
